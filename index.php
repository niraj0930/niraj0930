...
<!--navigation-------------->
    <nav> 
        ...
        <ul class="menu">
            ...
            <li><a href="bw.html">Bollywood </a></li>
            <li><a href="hw.html">Hollywood</a></li>
            <li><a href="tw.html">Tollywood</a></li>
        </ul>
        <!--search------------->
        <div class="search">
    ...
    </nav><?php include('container.php');?>
<div class="container">  
 <h2>GIVE MOVIE REVIEW AND RATING</h2>
 <?php
 ...
 <div id="ratingDetails">   
  <div class="row">   
   ...
   <div class="col-sm-3">
    <button type="button" id="rateProduct" class="btn btn-default">Rate This Movie</button>
   </div>  
  </div>
  <div class="row">
   <div class="col-sm-7">
    ...
    ?>    
     <div class="row">
      <div class="col-sm-3">
       <img src="pro.png" class="img-rounded" width="60" height="60">
 ...
 <div style="margin:50px 0px 0px 0px;">
  <a class="btn btn-default read-more" style="background:#3399ff;color:white" href="page.html">Back</a>  
 </div>
</div> 
